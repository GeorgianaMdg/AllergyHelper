...
p.a{
  font-family: "Mohave Regular", Regular, serif;
  font-size: 125%;
}
.button {
 size: 100%;
...
<head>
  ...
  })(window, document, '_gscq','script','//widgets.getsitecontrol.com/137569/script.js');
</script>
...
<body style="background-color: #191919;">
    ...
    <form class="form-inline my-2 my-lg-0">
      ...
      <a href="index.php?logout='1'" class="nav-link" style="color: white;">Logout</a>
    </form>
